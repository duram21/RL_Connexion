...
class ConnexionEnv:
    def __init__(self, seed: int = 0):
        ...
        # 🔥 Obs 차원 증가: Board(1024) + MyHand(80) + OppHand(80) = 1184
    ...
    def _opponent_model_move(self, model, device):
        ...
        if self.board[c_idx] != -1: self._opponent_random()
        else: self._apply_move(is_agent=False, slot=slot, cell_idx=c_idx)
